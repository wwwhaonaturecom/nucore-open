...
role :web, "admin.nubic.northwestern.edu"                          # Your HTTP server, Apache/etc
role :app, "admin.nubic.northwestern.edu"                          # This may be the same as your `Web` server
role :db,  "admin.nubic.northwestern.edu", :primary => true        # This is where Rails migrations will run
