Nucore::Application.configure do
  ...
  config.action_mailer.default_url_options   = { :host => "nucore-test.northwestern.edu", :protocol => 'https' }
  ...
  config.surveyor_redirects_to='https://nucore-test.northwestern.edu'
end
