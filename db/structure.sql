...
CREATE SEQUENCE "DELAYED_JOBS_SEQ"
...
CREATE SEQUENCE "TRAINING_REQUESTS_SEQ"
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00371382 PRIMARY KEY (ID)
)
...
CREATE  INDEX "INDEX_ACCOUNTS_ON_FACILITY_ID" ON "ACCOUNTS" ("FACILITY_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00371389 PRIMARY KEY (ID)
)
...
CREATE  INDEX "I_ACCOUNT_USERS_ACCOUNT_ID" ON "ACCOUNT_USERS" ("ACCOUNT_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00371391 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00371395 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "EXPIRES_AT" DATE NOT NULL,
 CONSTRAINT SYS_C00371401 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00371406 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "ATTEMPTS" NUMBER(38,0) DEFAULT 0  NOT NULL,
 ...
 CONSTRAINT SYS_C00371413 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372371 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372373 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_EXTERNAL_PASSER_ID" ON "EXTERNAL_SERVICE_PASSERS" ("PASSER_ID", "PASSER_TYPE")

/

CREATE  INDEX "I_EXT_SER_PAS_EXT_SER_ID" ON "EXTERNAL_SERVICE_PASSERS" ("EXTERNAL_SERVICE_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "RESPONSE_DATA" CLOB,
 CONSTRAINT SYS_C00372375 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_EXTERNAL_RECEIVER_ID" ON "EXTERNAL_SERVICE_RECEIVERS" ("RECEIVER_ID", "RECEIVER_TYPE")

/

CREATE  INDEX "I_EXT_SER_REC_EXT_SER_ID" ON "EXTERNAL_SERVICE_RECEIVERS" ("EXTERNAL_SERVICE_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372387 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372395 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_FAC_ACC_FAC_ID" ON "FACILITY_ACCOUNTS" ("FACILITY_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C00372400 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_INS_STA_INS_ID" ON "INSTRUMENT_STATUSES" ("INSTRUMENT_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372405 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_JOURNALS_ON_FACILITY_ID" ON "JOURNALS" ("FACILITY_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372411 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_JOURNAL_ROWS_JOURNAL_ID" ON "JOURNAL_ROWS" ("JOURNAL_ID")

/

CREATE  INDEX "I_JOURNAL_ROWS_ORDER_DETAIL_ID" ON "JOURNAL_ROWS" ("ORDER_DETAIL_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 "DATE" DATE NOT NULL,
 CONSTRAINT SYS_C00372414 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372421 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372424 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 "VALUE" VARCHAR2(16) NOT NULL,
 "AUXILIARY" VARCHAR2(512),
 CONSTRAINT SYS_C00372427 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 "VALUE" VARCHAR2(16) NOT NULL,
 "AUXILIARY" VARCHAR2(512),
 CONSTRAINT SYS_C00372430 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "AUXILIARY" VARCHAR2(512),
 CONSTRAINT SYS_C00372433 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "STARTS_AT" DATE,
 "EXPIRES_AT" DATE,
 CONSTRAINT SYS_C00372441 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372452 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 "VALUE" VARCHAR2(8) NOT NULL,
 "AUXILIARY" VARCHAR2(512),
 CONSTRAINT SYS_C00372455 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "ACTIVITY" VARCHAR2(16) NOT NULL,
 "AUXILIARY" VARCHAR2(512),
 CONSTRAINT SYS_C00372459 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372465 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_ORDERS_ON_ACCOUNT_ID" ON "ORDERS" ("ACCOUNT_ID")

/

CREATE  INDEX "INDEX_ORDERS_ON_FACILITY_ID" ON "ORDERS" ("FACILITY_ID")

/

CREATE  INDEX "INDEX_ORDERS_ON_STATE" ON "ORDERS" ("STATE")
...
CREATE  INDEX "I_ORDERS_MERGE_WITH_ORDER_ID" ON "ORDERS" ("MERGE_WITH_ORDER_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "PROBLEM" NUMBER(1,0) DEFAULT 0  NOT NULL,
 "DISPUTE_BY_ID" NUMBER(38,0),
 CONSTRAINT SYS_C00372472 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_ORDER_DETAILS_ON_PROBLEM" ON "ORDER_DETAILS" ("PROBLEM")

/

CREATE  INDEX "INDEX_ORDER_DETAILS_ON_STATE" ON "ORDER_DETAILS" ("STATE")

/

CREATE  INDEX "I_ORDER_DETAILS_ACCOUNT_ID" ON "ORDER_DETAILS" ("ACCOUNT_ID")

/

CREATE  INDEX "I_ORDER_DETAILS_GROUP_ID" ON "ORDER_DETAILS" ("GROUP_ID")

/

CREATE  INDEX "I_ORDER_DETAILS_JOURNAL_ID" ON "ORDER_DETAILS" ("JOURNAL_ID")

/

CREATE  INDEX "I_ORDER_DETAILS_ORDER_ID" ON "ORDER_DETAILS" ("ORDER_ID")

/

CREATE  INDEX "I_ORDER_DETAILS_PRODUCT_ID" ON "ORDER_DETAILS" ("PRODUCT_ID")

/

CREATE  INDEX "I_ORDER_DETAILS_STATEMENT_ID" ON "ORDER_DETAILS" ("STATEMENT_ID")

/

CREATE  INDEX "I_ORD_DET_ASS_USE_ID" ON "ORDER_DETAILS" ("ASSIGNED_USER_ID")

/

CREATE  INDEX "I_ORD_DET_BUN_PRO_ID" ON "ORDER_DETAILS" ("BUNDLE_PRODUCT_ID")

/

CREATE  INDEX "I_ORD_DET_ORD_STA_ID" ON "ORDER_DETAILS" ("ORDER_STATUS_ID")

/

CREATE  INDEX "I_ORD_DET_PAR_ORD_DET_ID" ON "ORDER_DETAILS" ("PARENT_ORDER_DETAIL_ID")

/

CREATE  INDEX "I_ORD_DET_PRI_POL_ID" ON "ORDER_DETAILS" ("PRICE_POLICY_ID")

/

CREATE  INDEX "I_ORD_DET_PRO_ACC_ID" ON "ORDER_DETAILS" ("PRODUCT_ACCESSORY_ID")

/

CREATE  INDEX "I_ORD_DET_RES_SET_ID" ON "ORDER_DETAILS" ("RESPONSE_SET_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "FAIL_ON_ERROR" NUMBER(1,0) DEFAULT 1,
 ...
 CONSTRAINT SYS_C00372476 PRIMARY KEY (ID)
)
...
CREATE  INDEX "I_ORDER_IMPORTS_FACILITY_ID" ON "ORDER_IMPORTS" ("FACILITY_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "LFT" NUMBER(38,0),
 "RGT" NUMBER(38,0),
 CONSTRAINT SYS_C00372479 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372481 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "ADMIN_EDITABLE" NUMBER(1,0) DEFAULT 1  NOT NULL,
 CONSTRAINT SYS_C00372487 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "USER_ID" NUMBER(38,0),
 "ACCOUNT_ID" NUMBER(38,0),
 CONSTRAINT SYS_C00372491 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_PRICE_GROUP_MEMBERS_USER_ID" ON "PRICE_GROUP_MEMBERS" ("USER_ID")

/

CREATE  INDEX "I_PRI_GRO_MEM_ACC_ID" ON "PRICE_GROUP_MEMBERS" ("ACCOUNT_ID")

/

CREATE  INDEX "I_PRI_GRO_MEM_PRI_GRO_ID" ON "PRICE_GROUP_MEMBERS" ("PRICE_GROUP_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372495 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372502 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_PRICE_POLICIES_PRODUCT_ID" ON "PRICE_POLICIES" ("PRODUCT_ID")

/

CREATE  INDEX "I_PRI_POL_PRI_GRO_ID" ON "PRICE_POLICIES" ("PRICE_GROUP_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "LOCK_WINDOW" NUMBER(38,0) DEFAULT 0  NOT NULL,
 CONSTRAINT SYS_C00372515 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_PRODUCTS_ON_FACILITY_ID" ON "PRODUCTS" ("FACILITY_ID")

/

CREATE  INDEX "INDEX_PRODUCTS_ON_URL_NAME" ON "PRODUCTS" ("URL_NAME")
...
CREATE  INDEX "I_PRODUCTS_FACILITY_ACCOUNT_ID" ON "PRODUCTS" ("FACILITY_ACCOUNT_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "DELETED_AT" DATE,
 CONSTRAINT SYS_C00372520 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_PRO_ACC_ACC_ID" ON "PRODUCT_ACCESSORIES" ("ACCESSORY_ID")

/

CREATE  INDEX "I_PRO_ACC_PRO_ID" ON "PRODUCT_ACCESSORIES" ("PRODUCT_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372523 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_PRO_ACC_GRO_PRO_ID" ON "PRODUCT_ACCESS_GROUPS" ("PRODUCT_ID")
...
CREATE  INDEX "IA58C53A0F332BE5A5FF9CAE48E120" ON "PRODUCT_ACCESS_SCHEDULE_RULES" ("PRODUCT_ACCESS_GROUP_ID")

/

CREATE  INDEX "I_PRO_ACC_SCH_RUL_SCH_RUL_ID" ON "PRODUCT_ACCESS_SCHEDULE_RULES" ("SCHEDULE_RULE_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "REQUESTED_AT" DATE,
 CONSTRAINT SYS_C00372531 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_PRODUCT_USERS_ON_USER_ID" ON "PRODUCT_USERS" ("USER_ID")

/

CREATE  INDEX "I_PRODUCT_USERS_PRODUCT_ID" ON "PRODUCT_USERS" ("PRODUCT_ID")

/

CREATE  INDEX "I_PRO_USE_PRO_ACC_GRO_ID" ON "PRODUCT_USERS" ("PRODUCT_ACCESS_GROUP_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 "AUTO_LOGOUT_MINUTES" NUMBER(38,0) DEFAULT 60,
 CONSTRAINT SYS_C00372533 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372538 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_RESERVATIONS_ORDER_DETAIL_ID" ON "RESERVATIONS" ("ORDER_DETAIL_ID")

/

CREATE  INDEX "I_RESERVATIONS_PRODUCT_ID" ON "RESERVATIONS" ("PRODUCT_ID")

/

CREATE  INDEX "I_RES_PRO_ID_RES_STA_AT" ON "RESERVATIONS" ("PRODUCT_ID", "RESERVE_START_AT")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372540 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372555 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "ACCOUNT_ID" NUMBER(38,0) NOT NULL,
 CONSTRAINT SYS_C00372562 PRIMARY KEY (ID)
)

/

CREATE  INDEX "INDEX_STATEMENTS_ON_ACCOUNT_ID" ON "STATEMENTS" ("ACCOUNT_ID")

/

CREATE  INDEX "I_STATEMENTS_FACILITY_ID" ON "STATEMENTS" ("FACILITY_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372566 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_STATEMENT_ROWS_STATEMENT_ID" ON "STATEMENT_ROWS" ("STATEMENT_ID")

/

CREATE  INDEX "I_STA_ROW_ORD_DET_ID" ON "STATEMENT_ROWS" ("ORDER_DETAIL_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "FILE_FILE_SIZE" NUMBER(38,0),
 "FILE_UPDATED_AT" DATE,
 CONSTRAINT SYS_C00372572 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_STORED_FILES_CREATED_BY" ON "STORED_FILES" ("CREATED_BY")

/

CREATE  INDEX "I_STORED_FILES_ORDER_DETAIL_ID" ON "STORED_FILES" ("ORDER_DETAIL_ID")

/

CREATE  INDEX "I_STORED_FILES_PRODUCT_ID" ON "STORED_FILES" ("PRODUCT_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "UPDATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C00374053 PRIMARY KEY (ID)
)

/

CREATE  INDEX "I_TRAINING_REQUESTS_PRODUCT_ID" ON "TRAINING_REQUESTS" ("PRODUCT_ID")

/

CREATE  INDEX "I_TRAINING_REQUESTS_USER_ID" ON "TRAINING_REQUESTS" ("USER_ID")
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "UID" NUMBER(38,0),
 CONSTRAINT SYS_C00372576 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C00372580 PRIMARY KEY (ID)
)
...
ALTER TABLE "BI_NETIDS" ADD CONSTRAINT "SYS_C00372604" FOREIGN KEY ("FACILITY_ID") REFERENCES "FACILITIES"("ID")
...
ALTER TABLE "ORDER_DETAILS" ADD CONSTRAINT "ORDER_DETAILS_DISPUTE_BY_ID_FK" FOREIGN KEY ("DISPUTE_BY_ID") REFERENCES "USERS"("ID")
...
ALTER TABLE "ORDER_IMPORTS" ADD CONSTRAINT "FK_ORDER_IMPORTS_FACILITIES" FOREIGN KEY ("FACILITY_ID") REFERENCES "FACILITIES"("ID")
...
INSERT INTO schema_migrations (version) VALUES ('20140320184445')

/

INSERT INTO schema_migrations (version) VALUES ('20140325172600')

/

INSERT INTO schema_migrations (version) VALUES ('20140410170132')

/

INSERT INTO schema_migrations (version) VALUES ('20140527201943')

/

INSERT INTO schema_migrations (version) VALUES ('20140730215658')

/

INSERT INTO schema_migrations (version) VALUES ('20140730222842')

/

INSERT INTO schema_migrations (version) VALUES ('20140831183702')

/

INSERT INTO schema_migrations (version) VALUES ('20140908192950')

/

INSERT INTO schema_migrations (version) VALUES ('20140917204555')

/

INSERT INTO schema_migrations (version) VALUES ('20140924163849')

/

INSERT INTO schema_migrations (version) VALUES ('20140924204847')

/

INSERT INTO schema_migrations (version) VALUES ('20140924211413')

/

INSERT INTO schema_migrations (version) VALUES ('20140924222724')

/

INSERT INTO schema_migrations (version) VALUES ('20141104233110')

/

INSERT INTO schema_migrations (version) VALUES ('20141120172247')

/

INSERT INTO schema_migrations (version) VALUES ('20141125002918')

/

INSERT INTO schema_migrations (version) VALUES ('20141125003918')

/

INSERT INTO schema_migrations (version) VALUES ('20150115151805')

/

INSERT INTO schema_migrations (version) VALUES ('20150121202952')

/

INSERT INTO schema_migrations (version) VALUES ('20150204174650')

/

INSERT INTO schema_migrations (version) VALUES ('20150318015754')

/

INSERT INTO schema_migrations (version) VALUES ('20150605165610')

/

INSERT INTO schema_migrations (version) VALUES ('20150611175130')
