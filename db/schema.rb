...
ActiveRecord::Schema.define(version: 20160803182750) do
  ...
  create_table "account_users", force: :cascade do |t|
    ...
    t.integer  "deleted_by",             precision: 38
  end
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.integer  "expiration_month",                   precision: 38
    t.integer  "expiration_year",                    precision: 38
    t.datetime "created_at",                                        null: false
    t.integer  "created_by",                         precision: 38, null: false
    ...
    t.integer  "affiliate_id",           limit: nil
  ...
  create_table "bundle_products", force: :cascade do |t|
    t.integer "bundle_product_id", limit: nil,                null: false
  ...
  create_table "external_service_receivers", force: :cascade do |t|
    t.integer  "external_service_id", limit: nil
    t.integer  "receiver_id",         limit: nil
    t.string   "receiver_type"
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.string   "external_id"
    t.text     "response_data"
    t.boolean  "manages_quantity",    limit: nil, default: false, null: false
  end
  ...
  create_table "facilities", force: :cascade do |t|
    ...
    t.boolean  "is_active",                    limit: nil,                 null: false
    t.datetime "created_at",                                               null: false
    t.datetime "updated_at",                                               null: false
    t.text     "description"
    t.boolean  "accepts_cc",                   limit: nil, default: true
    t.boolean  "accepts_po",                   limit: nil, default: true
    ...
    t.boolean  "accepts_multi_add",            limit: nil, default: false, null: false
  ...
  create_table "facility_accounts", force: :cascade do |t|
    ...
    t.integer  "created_by",                  precision: 38, null: false
    t.datetime "created_at",                                 null: false
    t.integer  "revenue_account",             precision: 38, null: false
  end
  ...
  create_table "instrument_statuses", force: :cascade do |t|
    ...
    t.boolean  "is_on",         limit: nil, null: false
    t.datetime "created_at",                null: false
  end
  ...
  create_table "journal_rows", force: :cascade do |t|
    t.integer "journal_id",      limit: nil,                         null: false
  ...
  create_table "journals", force: :cascade do |t|
    ...
    t.string   "description",       limit: 200
    t.boolean  "is_successful",     limit: nil
    t.integer  "created_by",                    precision: 38, null: false
    t.datetime "created_at",                                   null: false
    t.integer  "updated_by",                    precision: 38
    t.datetime "updated_at"
  ...
  create_table "jxml_holidays", force: :cascade do |t|
  ...
  create_table "nucs_chart_field1s", force: :cascade do |t|
    t.string "value",     limit: 16,  null: false
    t.string "auxiliary", limit: 512
  end
  ...
  create_table "nucs_departments", force: :cascade do |t|
    t.string "value",     limit: 16,  null: false
    t.string "auxiliary", limit: 512
  end
  ...
  create_table "nucs_funds", force: :cascade do |t|
  ...
  create_table "nucs_gl066s", force: :cascade do |t|
  ...
  create_table "nucs_grants_budget_trees", force: :cascade do |t|
    t.string   "account",              limit: 16, null: false
  ...
  create_table "nucs_programs", force: :cascade do |t|
    t.string "value",     limit: 8,   null: false
    t.string "auxiliary", limit: 512
  end
  ...
  create_table "nucs_project_activities", force: :cascade do |t|
    t.string "project",   limit: 16,  null: false
    t.string "activity",  limit: 16,  null: false
    t.string "auxiliary", limit: 512
  end
  ...
  create_table "order_details", force: :cascade do |t|
    t.integer  "order_id",                limit: nil,                                          null: false
    t.integer  "product_id",              limit: nil,                                          null: false
    t.integer  "quantity",                            precision: 38,                           null: false
    t.integer  "price_policy_id",         limit: nil
    t.decimal  "actual_cost",                         precision: 10, scale: 2
    t.decimal  "actual_subsidy",                      precision: 10, scale: 2
    t.integer  "assigned_user_id",        limit: nil
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "order_status_id",         limit: nil
    ...
    t.integer  "journal_id",              limit: nil
    t.string   "reconciled_note"
    t.integer  "created_by",                          precision: 38,                           null: false
    t.integer  "parent_order_detail_id",  limit: nil
    t.integer  "product_accessory_id",    limit: nil
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer  "facility_id",         limit: nil
    t.string   "state",               limit: 50
    t.integer  "merge_with_order_id", limit: nil
    t.integer  "order_import_id",     limit: nil
  end
  ...
  create_table "pmu_departments", force: :cascade do |t|
  ...
  create_table "price_group_members", force: :cascade do |t|
    t.string  "type",           limit: 50,  null: false
    t.integer "price_group_id", limit: nil, null: false
  ...
  create_table "price_group_products", force: :cascade do |t|
    t.integer  "price_group_id",     limit: nil,                null: false
    t.integer  "product_id",         limit: nil,                null: false
    t.integer  "reservation_window",             precision: 38
    t.datetime "created_at",                                    null: false
    t.datetime "updated_at",                                    null: false
  end
  ...
  create_table "price_groups", force: :cascade do |t|
    t.integer "facility_id",    limit: nil
    t.string  "name",           limit: 50,                                null: false
    t.integer "display_order",              precision: 38,                null: false
    t.boolean "is_internal",    limit: nil,                               null: false
    t.boolean "admin_editable", limit: nil,                default: true, null: false
  end
  ...
  create_table "price_policies", force: :cascade do |t|
    ...
    t.integer  "usage_mins",                      precision: 38
    t.decimal  "reservation_rate",                precision: 12, scale: 4
    t.integer  "reservation_mins",                precision: 38
    t.decimal  "overage_rate",                    precision: 12, scale: 4
    t.integer  "overage_mins",                    precision: 38
    ...
    t.boolean  "can_purchase",        limit: nil,                          default: false, null: false
    t.string   "charge_for"
  end
  ...
  create_table "product_access_schedule_rules", id: false, force: :cascade do |t|
    t.integer "product_access_group_id", limit: nil, null: false
    t.integer "schedule_rule_id",        limit: nil, null: false
  end
  ...
  create_table "product_accessories", force: :cascade do |t|
    t.integer  "product_id",   limit: nil,                      null: false
    t.integer  "accessory_id", limit: nil,                      null: false
  ...
  create_table "product_users", force: :cascade do |t|
    t.integer  "product_id",              limit: nil,                null: false
    t.integer  "user_id",                 limit: nil,                null: false
    t.integer  "approved_by",                         precision: 38, null: false
    t.datetime "approved_at",                                        null: false
    t.integer  "product_access_group_id", limit: nil
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.string   "url_name",                  limit: 50,                                 null: false
    t.text     "description"
    t.boolean  "requires_approval",         limit: nil,                                null: false
    t.integer  "initial_order_status_id",   limit: nil
    t.boolean  "is_archived",               limit: nil,                                null: false
    t.boolean  "is_hidden",                 limit: nil,                                null: false
    t.datetime "created_at",                                                           null: false
    t.datetime "updated_at",                                                           null: false
    t.integer  "min_reserve_mins",                      precision: 38
    t.integer  "max_reserve_mins",                      precision: 38
    t.integer  "min_cancel_hours",                      precision: 38
    t.integer  "facility_account_id",       limit: nil
    t.string   "account",                   limit: 5
    t.boolean  "show_details",              limit: nil,                default: false, null: false
    t.integer  "auto_cancel_mins",                      precision: 38
    t.string   "contact_email"
    t.integer  "schedule_id",               limit: nil
  ...
  create_table "relays", force: :cascade do |t|
    ...
    t.boolean  "auto_logout",         limit: nil
    t.string   "type"
    t.datetime "created_at",                                                  null: false
    t.datetime "updated_at",                                                  null: false
    t.integer  "auto_logout_minutes",             precision: 38, default: 60
  end
  ...
  create_table "splits", force: :cascade do |t|
    ...
    t.integer "subaccount_id",           limit: nil,                         null: false
    t.decimal "percent",                             precision: 6, scale: 3, null: false
    t.boolean "apply_remainder",         limit: nil,                         null: false
  end
  ...
  create_table "statement_rows", force: :cascade do |t|
    t.integer  "statement_id",    limit: nil, null: false
    t.integer  "order_detail_id", limit: nil, null: false
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  end
  ...
  create_table "versions", force: :cascade do |t|
    ...
    t.integer  "version_number",                precision: 38
    t.string   "tag"
    t.datetime "created_at",                                   null: false
    t.datetime "updated_at",                                   null: false
    t.string   "reason_for_update"
    t.integer  "reverted_from",                 precision: 38
