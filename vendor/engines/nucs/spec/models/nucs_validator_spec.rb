...
RSpec.describe NucsValidator do
  ...
  it "should allow just a fund and department" do
    ...
    expect(validator.components.reject { |_k, v| v.nil? }).to eq(fund: "123", dept: "1234567")
  end

  it "should allow a fund, department, and project" do
    validator = NucsValidator.new("123-1234567-12345678")
    expect(validator.components.reject { |_k, v| v.nil? }).to eq(fund: "123", dept: "1234567", project: "12345678")
  end
  ...
  it "should allow averything and an activity" do
    ...
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", project: "12345678", activity: "12")
  end

  it "should allow everything with a program" do
    validator = NucsValidator.new("123-1234567-12345678-12-1234")
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", project: "12345678", activity: "12", program: "1234")
  end

  it "should allow everything including chart_field1" do
    validator = NucsValidator.new("123-1234567-12345678-12-1234-4321")
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", project: "12345678", activity: "12", program: "1234", chart_field1: "4321")
  end

  it "should allow a chartfield1 with just fund and department" do
    validator = NucsValidator.new("123-1234567----1025")
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", chart_field1: "1025")
  end

  it "should allow skipping program" do
    validator = NucsValidator.new("123-1234567-12345678-12--1234")
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", project: "12345678", activity: "12", chart_field1: "1234")
  end
  ...
  it "should allow skipping activity" do
    ...
    expect(validator.components.reject { |_k, v| v.blank? }).to eq(fund: "123", dept: "1234567", project: "12345678", program: "1234")
  end
  ...
  it "should return the later of matching expiration dates" do
    ...
    define_gl066(NON_GRANT_CS, expires_at: three_year_later - 2.years)
  ...
  it "should return nil when there is no match on components" do
    define_gl066(NON_GRANT_CS, expires_at: Time.zone.now + 3.years)
  ...
  it 'should return a date when there is no activity given and "-" exists in the DB' do
    define_gl066(NON_GRANT_CS, expires_at: Time.zone.now + 3.years, activity: NucsValidator::NUCS_BLANK)
