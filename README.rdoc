...
* Ruby[http://www.ruby-lang.org/en] 1.8.7 or 1.9.2
* Ruby On Rails[http://rubyonrails.org] 3.0.10
...
* Wondering how you can customize NU Core for your institution? <b>See HOWTO_extensions.txt</b>
